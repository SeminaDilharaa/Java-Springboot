...
public class Worker {
	...
	public Worker(String worker_id, String workerName, double hourlyRate, lk.ac.vau.Model.Worker.SkillType skillType,
			Worker supervisor, List<Assignment> workAssignments) {
		super();
		Worker_id = worker_id;
